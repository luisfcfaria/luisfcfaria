...
public class WebServer {
    ...
    public void start(int port) throws IOException {
        ...
        serveRequests(serverSocket, executor);
    }

    public void serveRequests(ServerSocket socket, ExecutorService executor) {
        ...
        while (true) {
            try {
                ...
                System.out.println(Messages.CLIENT_CONNECTION_ERROR);
            }
        }
    }
